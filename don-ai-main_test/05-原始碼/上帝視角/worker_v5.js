// line-redirect Worker v5 - 主資料庫像素自動合併
// 變更：從 Config API 讀取 MASTER_PIXEL_MAP，按 tag 自動附加主資料庫像素
// 廣告像素（ad_config）和主資料庫像素（MASTER_PIXEL_MAP）分開管理，Worker 合併
