...
帳戶 ID：     61f1eb800e48d2cf41ed9ddacf01581b
...
```bash
curl -X PUT "https://api.cloudflare.com/client/v4/accounts/61f1eb800e48d2cf41ed9ddacf01581b/workers/scripts/safe-page" \
...
```bash
curl -X PUT "https://api.cloudflare.com/client/v4/accounts/61f1eb800e48d2cf41ed9ddacf01581b/workers/scripts/money-page" \
  -H "Authorization: Bearer cfut_xAy57a8x6pmDzCM8BGi5A0nWkrvYjVJfodWB8teV4f64c32f" \
  -H "Content-Type: application/javascript" \
...
```bash
curl -X PUT "https://api.cloudflare.com/client/v4/accounts/61f1eb800e48d2cf41ed9ddacf01581b/workers/scripts/shadow-cloak" \
  -H "Authorization: Bearer cfut_xAy57a8x6pmDzCM8BGi5A0nWkrvYjVJfodWB8teV4f64c32f" \
  -H "Content-Type: application/javascript" \
